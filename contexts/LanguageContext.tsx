      ...
      experienceItems: [
        {
          ...
          bullets: [
            'Built internal dashboards to monitor predictive-maintenance KPIs with React and TypeScript.',
            'Integrated sensor data pipelines using Node.js and MySQL, reducing manual reporting time by 35%.',
            'Collaborated with data-science teams to productionize machine-learning models within the platform.',
          ],
        },
      ],
      educationItems: [
        {
          ...
          bullets: [
            'Focused on software engineering, cloud computing, and digital transformation.',
            'Developed academic projects in full-stack development, IoT, and system design.',
            'Currently pursuing final-year studies with a specialization in software architecture.',
          ],
        },
        {
          year: '2025',
      ...
      experienceItems: [
        {
          ...
          bullets: [
            'Développement de tableaux de bord internes pour le suivi des KPI de maintenance prédictive avec React et TypeScript.',
            'Intégration de flux de données capteurs via Node.js et MySQL, réduisant de 35 % le temps de génération des rapports.',
            'Collaboration avec les équipes data science pour industrialiser les modèles d\'apprentissage automatique.',
          ],
        },
      ],
      educationItems: [
